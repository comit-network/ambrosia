...
// TODO: Change this to whatever we agree on for API change
export function buyMockSwap(href: string, mockAction: string): AxiosResponse<Entity> {
    // @ts-ignore
    return {
        data: {
            class: [
            ...
            entities: [
                ...
                },
                {
                    ...
                    properties: {
                        events: {
                            deploy: "0x45b5f566f74e0a08f043f42a59ca36d02b7b321cc8560b8f1464d081d3d0d89b"
                        },
                        status: "DEPLOYED"
                    },
                    entities: [],
